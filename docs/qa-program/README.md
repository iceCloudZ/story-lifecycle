...
| T1.3 | no_progress 终止(防死循环) | `[阻塞]` | [原报告](reports/T1.3-gate-no-progress.md) · [复核补充](reports/T1.3-no-progress-revisit.md) | `a246e5d6` |
...
| T3.3 | approval_queue 阻塞部署 | `[已完成/已澄清]` | [reports/T3.3-approval-blocks-deploy.md](reports/T3.3-approval-blocks-deploy.md) | `21ba961d` |
...
| T4.5 | ⑥ 飞轮:anchors round-trip + 卸包照跑 | `[已完成]` | [reports/T4.5-anchors-round-trip.md](reports/T4.5-anchors-round-trip.md) | `22a5583d` |
...
| T5.2 | tests/invariants/ 目录 + 架构不变量集 | `[已完成]` | [reports/T5.2-architecture-invariants.md](reports/T5.2-architecture-invariants.md) | 待填写 |
