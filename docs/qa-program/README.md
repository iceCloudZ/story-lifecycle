...
| 卡号 | 任务 | 状态 | 报告 | commit |
|---|---|---|---|---|
| T1.1 | gate 硬闸不可绕(max_retries 强制 fail) | `[阻塞]` | [reports/T1.1-gate-hard-fail.md](reports/T1.1-gate-hard-fail.md) | 23fc3e7b(后续会更新) |
| T1.2 | gate 三判定(advance/retry/fail)分支覆盖 | `[待办]` | — | — |
